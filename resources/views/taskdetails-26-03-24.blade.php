                                            ...
                                            <div class="btcd-f-input">
                                                ...
                                                <div>
                                                    @php
                                                     ...
                                                     @endphp
                                                    <p>
                                                        <a href="../uploads/{{ @$value }}" style="color: blueviolet;">
                                                          <i class="fa fa-paperclip" aria-hidden="true"></i> {{ @$value }}
                                                        </a>
                                                    </p>
                                                     @php
                                                         }
                                        ...
                                        <div class="robud-text">
                                            <ul class="lsiu-you">
                                                ...
                                                <li>
                                                   ...
                                                   <form name="frmR" action="" method="POST">
                                                    <input type="hidden" name="id" value="{{ $data['id'] }}">
                                                    @csrf
                                                    <ul class="dropdown-menu smuy " aria-labelledby="dropdownMenuClickableInside">
                                                        <li>
                                                        <a id="clio" class="clois"> <i class="fas fa-times"></i> </a>
                                                        </li>
                                                        <li class="mt-top">
                                                        <input id="datetimepickerbu" class="form-control" placeholder="Select Date" type="text">
                                                        </li>
                                                        <li class="mt-top">
                                                        <select class="form-select mtu">
                                                            <option value="1">to responsible person</option>
                                                            <option value="2">to creator</option>
                                                            <option value="3">to self</option>
                                                        </select>
                                                        </li>
                                                        <li>
                                                        <button type="submit" name="btnr" class="btn btn-save"> Add </button>
                                                        </li>
                                                    </ul>
                                                    </form>
                                                    </div>
                                                ...
                                                <div class="d-flex align-items-start">
                                                  <figure class="m-0">
                                                    ...
                                                    <div class="right-houw ms-3 position-relative">
                                                      <div class="indoi">
                                                          <h5 class="nametxe"> {{ $sender[0]->name }} <small> 7:30pm</small> </h5>
                                                          <p> {{ $comment->comment }} </p>
                                                          <p>
                                                               @php
                                                                if($comment->files!='')
                                                                ...
                                                                @endphp
                                                                <p>
                                                                    <a href="../uploads/{{ @$val }}" style="color: blueviolet;">
                                                                    <i class="fa fa-paperclip" aria-hidden="true"></i> {{ @$val }}
                                                                    </a>
                                                                </p>
                                                                @php
                                                                    }
                                                        ...
                                                        <ul class="d-flex rplyt-group align-items-center mt-2">
                                                          <li class="d-flex lign-items-center">
                                                            <a id="like" class="d-flex lign-items-center">
                                                              <div id="count_like" class="zahl me-2">
                                              ...
                                              <div id="reply-main" class="messge-chat">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="chat-boxu05 ms-3">
                                                      <div class="cht">
                                                        <textarea class="form-control msui" name="comment" value="Subhojit Adhikary"></textarea>
