                        ...
                        <table id="examplee" class="display" style="width:100%">
                          <thead>
                            <tr>
                              ...
                              <th width="2%" style="text-align: center"><input type="checkbox" id="select_all" /></th>
                              @php } @endphp
                              <th width="35%">Name</th>
                              <th width="13%">Active</th>
                              <th width="13%">Deadline</th>
                              <!--<th>Created by</th>-->
                              <th width="22%">Responsible Person</th>
                            ...
                            @php if(session('role')=='Administrator') { @endphp
                              ...
                              <td>
                                <div class="dropdown crmo-drp dropend">
                                  ...
                                  @endphp
                                  <a class="btn thum-pin" href="viewtask/{{ $data['id'] }}">{{ $data['task_name'] }}</a>
                                  @php
                                      }
                                  @endphp
                                </div>
        ...
        <div class="d-block d-lg-none">
          ...
          <div class="test-block-div">
              ...
              <div class="textre-block">
                 <textarea class="form-control" id="newtask" name="task_description" placeholder="Write here...">
              ...
              <div class="minku-div">
                  ...
                  <div class="comoniut-listr d-md-flex align-items-center w-100 sp-marginu">
                    <div class="form-group boeder-top d-md-flex align-items-center">
