...
<div class="d-flex align-items-start bodyt blur01">
    <x-sidebar/>
    ...
    <div class="contentoi">
      <div class="boxu-body d-inline-block w-100">
        <x-taskcount/>
         ...
         <section class="mail-sercotu d-inline-block w-100 float-start w-100">
                <div class="onisde details-projects zoomin01 d-inline-block w-100" data-aos="zoom-in">

                    <div class="row">
                        <div class="col-lg-12">
                            <form name="frmtask" action="{{ URL::to('updatecomment') }}" method="POST" enctype="multipart/form-data">
