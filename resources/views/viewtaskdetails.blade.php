                                ...
                                <div class="w-100">
                                    <div class="comon-projetcs-details bg-white position-relative anew">
                                        ...
                                        <div class="textt-div w-100" style="padding:10px;">
                                            <textarea name="task_description" class="form-control" id="newtask">{{ $data['task_description'] }}</textarea>
                                        </div>
                                    ...
                                    <div class="footer-list02">
                                        <div class="d-flex align-items-center">
                                            <button type="button" id="btupdate" name="btnupdate" class="btn  btn-danger btn-pause"@php
                                            if($data['status']=='Completed') { echo 'disabled'; }
                                        @endphp> Pause </button>
                                            <button type="button" id="bfinish" name="btnfinish" class="btn btn-danger btn-pause ms-3"@php
                                            if($data['status']=='Completed') { echo 'disabled'; }
                                        @endphp> Mark As Finish </button>
                                        <button type="button" id="btback" name="btback" class="btn btn-danger btn-pause ms-3" onClick="javascript:history.go(-1)"> Back </button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                        ...
                                        <div class="robud-text">
                                            <ul class="lsiu-you">
                                                <li>
                                                    ...
                                                    <button class="btn protxrt dropdown-toggle close-dp" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                                        {{ $data['deadline'] }}
                                                    </button>
                                               </div>
												</form>
                                            ...
                                            <div class="creatre-divu">
                                                ...
                                                <div class="comonil-user my-4">
                                                    <a href="#" class="d-flex align-items-center w-100">
                                                        ...
                                                        <span>
                                                            @php
                                                                $participant = explode(",",trim($data['participants']));
                                            ...
                                            <div class="comooments-ser">
                                                        ...
                                                        <ul class="d-flex rplyt-group align-items-center mt-2">
                                                          ...
                                                          <li class="dropdown ms-3">
                                                            ...
                                                            <ul class="dropdown-menu spoicola" aria-labelledby="dropdownMenuButton1">
                                                              <li><a class="dropdown-item" id="deit1">Edit</a></li>
                                                              <li><a class="dropdown-item" id="del01">Delete</a></li>
                                                            </ul>
                                                          </li>
                                                        </ul>
                                                    </div>
                                              ...
                                              <div id="edit-reply-main" class="messge-chat mb-4">
                                                    ...
                                                    <div class="chat-boxu05 ms-3 rluyio">
                                                      <div class="cht">
                                                        <div class="height-spoui">
                                                          <input type="text" name="editcomment" class="form-control msui" value="Subhojit Adhikary"/>
                                                        </div>
                                                ...
                                                <div class="d-flex align-items-center group-send01">
                                                    <button type="submit" name="btnreply" class="btn btn-send"> Send </button>
...
<script>
    ...
    var firebaseConfig = {
        apiKey: "AIzaSyA0UfRUxZrbtBbo-T51xYtE6B1C3avPobQ",
        authDomain: "writerzcenter.firebaseapp.com",
        projectId: "writerzcenter",
        storageBucket: "writerzcenter.appspot.com",
        messagingSenderId: "565095692499",
        appId: "1:565095692499:web:e52d95508a365526a43c26",
        measurementId: "G-BLPZJELDZ4"
    };
