                      ...
                      <div class="d-flex align-items-center subnm-menu-div">
                          <div class="letfr-menus">
                            <ul class="d-flex align-items-center">
                              <li>
                                <a href="{{ URL::to('usertasks') }}" class="menu05"> List </a>
                              </li>
                              <li>
                                <a href="{{ URL::to('taskdeadlines') }}" class="menu05 active-me"> Deadline </a>
                              </li>
                            </ul>
                          </div>
                      </div>
                ...
                <div class="onisde d-inline-block w-100 position-relative">
                  <table id="ongoing" class="display" style="width:100%">
                    ...
                    <tbody>
                      @php
                       $id = session('userid');
                       $pending = \DB::table('tasks')->where('responsible_person', $id)->where('deadline', '<' , date('Y/m/d h:i:s'))->get();
