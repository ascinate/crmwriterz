            ...
            <x-taskcountuser/>
              ...
              <section class="mail-sercotu d-inline-block w-100">
                <div class="onisde d-inline-block w-100 position-relative">
                  <table id="comments2" class="display" style="width:100%">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                     @php
                       ...
                       foreach($datas as $data)
                       {
                          ...
                          $count = \DB::table('commentcounts')->where('userid', $uid)->where('taskid', $data->taskid)->count();
                     @endphp
                     <tr>
                       <td>
                       ...
                       <td>
                        <div class="dropdown crmo-drp dropend">
                            <a class="btn thum-pin" href="{{ URL::to('viewtask') }}/{{ $task[0]->id }}">
